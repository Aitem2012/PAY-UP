...
namespace PAY_UP.Api.Controllers{
    ...
    public class DebtorsController : ControllerBase{
        ...
        [HttpPost("make-repayment", Name = nameof(MakeRepayment)), ProducesResponseType(typeof(ResponseObject<GetDebtorDto>), StatusCodes.Status200OK), ProducesDefaultResponseType]
